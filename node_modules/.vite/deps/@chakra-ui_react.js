...
function usePresence() {
  ...
  (0, import_react9.useEffect)(() => register(id3), []);
  const safeToRemove = (0, import_react9.useCallback)(() => onExitComplete && onExitComplete(id3), [id3, onExitComplete]);
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime6.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react12.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
// node_modules/framer-motion/dist/es/utils/use-isomorphic-effect.mjs
var useIsomorphicLayoutEffect = isBrowser2 ? import_react15.useLayoutEffect : import_react15.useEffect;
...
function useVisualElement(Component3, visualState, props, createVisualElement2, ProjectionNodeConstructor) {
  ...
  const visualElementRef = (0, import_react17.useRef)();
  ...
  const wantsHandoff = (0, import_react17.useRef)(Boolean(optimisedAppearId) && !window.MotionHandoffIsComplete && ((_a2 = window.MotionHasOptimisedAnimation) === null || _a2 === void 0 ? void 0 : _a2.call(window, optimisedAppearId)));
...
function createRendererMotionComponent({ preloadedFeatures, createVisualElement: createVisualElement2, useRender, useVisualState: useVisualState2, Component: Component3 }) {
  ...
  const ForwardRefMotionComponent = (0, import_react20.forwardRef)(MotionComponent);
...
function buildHTMLStyles(state2, latestValues, transformTemplate) {
  const { style, vars, transformOrigin: transformOrigin2 } = state2;
...
function calcOrigin2(origin, offset2, size) {
...
function updateMotionValuesFromProps(element, next, prev) {
  for (const key in next) {
    ...
    if (isMotionValue(nextValue)) {
      ...
      if (true) {
        warnOnce(nextValue.version === "11.9.0", `Attempting to mix Framer Motion versions ${nextValue.version} with 11.9.0 may not work as expected.`);
      }
...
function useMotionValue(initial) {
  ...
  if (isStatic) {
    const [, setLatest] = (0, import_react37.useState)(initial);
    (0, import_react37.useEffect)(() => value.on("change", setLatest), []);
  }
  return value;
}
...
function hydrateKeyframes(valueName, keyframes3, read2) {
  for (let i = 0; i < keyframes3.length; i++) {
    if (keyframes3[i] === null) {
      keyframes3[i] = i === 0 ? read2() : keyframes3[i - 1];
    }
    if (typeof keyframes3[i] === "number" && browserNumberValueTypes[valueName]) {
      keyframes3[i] = browserNumberValueTypes[valueName].transform(keyframes3[i]);
    }
  }
  if (!supportsPartialKeyframes() && keyframes3.length < 2) {
    keyframes3.unshift(read2());
  }
}
...
function animateElements2(elementOrSelector, keyframes3, options, scope) {
  const elements = resolveElements(elementOrSelector, scope);
  const numElements = elements.length;
  invariant(Boolean(numElements), "No valid element provided.");
  const animations2 = [];
  for (let i = 0; i < numElements; i++) {
    ...
    for (const valueName in keyframes3) {
      const valueKeyframes = keyframes3[valueName];
      const valueOptions = {
...
var createScopedWaapiAnimate = (scope) => {
  function scopedAnimate(elementOrSelector, keyframes3, options) {
    return new GroupPlaybackControls(animateElements2(elementOrSelector, keyframes3, options, scope));
  }
  return scopedAnimate;
};
...
var ReorderContext = (0, import_react52.createContext)(null);
...
function ReorderGroupComponent({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  const order2 = [];
  const isReordering = (0, import_react53.useRef)(false);
  ...
  return (0, import_jsx_runtime15.jsx)(Component3, { ...props, ref: externalRef, ignoreStrict: true, children: (0, import_jsx_runtime15.jsx)(ReorderContext.Provider, { value: context, children }) });
}
var ReorderGroup = (0, import_react53.forwardRef)(ReorderGroupComponent);
...
function ReorderItemComponent({ children, style = {}, value, as = "li", onDrag, layout: layout3 = true, ...props }, externalRef) {
  const Component3 = useConstant(() => motion[as]);
  const context = (0, import_react54.useContext)(ReorderContext);
  const point = {
  ...
  return (0, import_jsx_runtime16.jsx)(Component3, { drag: axis, ...props, dragSnapToOrigin: true, style: { ...style, x: point.x, y: point.y, zIndex }, layout: layout3, onDrag: (event, gesturePoint) => {
    const { velocity } = gesturePoint;
    velocity[axis] && updateOrder(value, point[axis].get(), velocity[axis]);
    onDrag && onDrag(event, gesturePoint);
  }, onLayoutMeasure: (measured) => registerItem(value, measured), ref: externalRef, ignoreStrict: true, children });
}
var ReorderItem = (0, import_react54.forwardRef)(ReorderItemComponent);
...
var Checkbox = forwardRef(function Checkbox2(props, ref) {
  ...
  const iconStyles = (0, import_react88.useMemo)(
    ...
    [iconColor, iconSize, shouldAnimate, state2.isIndeterminate, styles.icon]
  );
